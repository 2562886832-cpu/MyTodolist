...
function initRuntimeSocketService() {
  const hosts = "192.168.157.1,192.168.150.1,192.168.165.161,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_5NZb84";
...
const tabBar = {
  list: [
    {
      text: "日历",
      pagePath: "pages/panel/panel",
      iconPath: "/static/icons/menu.png",
      selectedIconPath: "/static/icons/menu-.png"
    },
    {
      text: "时钟",
